    ...
    func fetchFromApi() {
        ...
        URLSession.shared.dataTask(with: url) { data, response, error in
            ...
            do {
                ...
                globalData.moduleData = InfoData(img: img, title: title, indicatorText: nil, currentCount: nil, totalCount: nil)
            } catch let error {
    ...
    var body: some View {
        VStack {
            if globalData.moduleData != nil {
                ...
                .onSubmit {
                    if globalData.module != nil {
                        ...
                        if globalData.module!.code["anime"]!["search"]!.callsApi != nil && globalData.module!.code["anime"]!["search"]!.callsApi! {
                            fetchFromApi()
                        } else {
            ...
            if viewModel.htmlString.count > 0 {
                WebView(htmlString: viewModel.htmlString, javaScript: globalData.module!.code["anime"]!["search"]!.js, globalData: globalData)
                    .hidden()
